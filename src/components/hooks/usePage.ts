 ...
 * @LastEditTime: 2025-04-10 17:11:19
 * @FilePath: \lg-wms-admind:\自己搭建\vue\customize-pdf\src\components\hooks\usePage.ts
 */
import { onMounted, onUnmounted, ref } from "vue";

export const usePage = (pageRefs: HTMLElement,
